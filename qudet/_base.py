...
class BaseReducer(ABC):
    """
    Abstract Base Class for Data Reduction (The Smart Funnel).
    Ensures all reducers have fit/transform methods.
    """
...
class BaseEncoder(ABC):
    """
    Abstract Base Class for Quantum Encoding (The Bridge).
    """
    @abstractmethod
...
class BaseQuantumEstimator(ABC):
    """
    Abstract Base Class for Quantum Algorithms (The Brain).
    """
